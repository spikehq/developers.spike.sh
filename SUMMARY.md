...
* [API reference](api-reference/README.md)
  ...
  * [Api](api-reference/api/README.md)
    * [Status page](api-reference/api/status-page/README.md)
      * [All](api-reference/api/status-page/all.md)
      * [Component](api-reference/api/status-page/component/README.md)
        * [Create](api-reference/api/status-page/component/create.md)
      * [Incidents](api-reference/api/status-page/incidents.md)
      * [Planned maintenance](api-reference/api/status-page/planned-maintenance/README.md)
        * [Upcoming](api-reference/api/status-page/planned-maintenance/upcoming.md)
        * [Create](api-reference/api/status-page/planned-maintenance/create.md)
      * [Subscribers](api-reference/api/status-page/subscribers.md)
      * [Incident](api-reference/api/status-page/incident/README.md)
        * [New](api-reference/api/status-page/incident/new.md)
